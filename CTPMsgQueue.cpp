...
{
    CTPMsgQueue* pMsgQueue = reinterpret_cast<CTPMsgQueue *>(lpParam);
    if (pMsgQueue)
        pMsgQueue->RunInThread();
    return 0;
}

void CTPMsgQueue::RunInThread()
{
    while (m_bRunning)
    {
        if (Process())
...
void CTPMsgQueue::_Input_MD(SMsgItem* pMsgItem)
{
    m_queue_MD.enqueue(pMsgItem);
    SetEvent(m_hEvent);
}

void CTPMsgQueue::_Input_TD(SMsgItem* pMsgItem)
{
    m_queue_TD.enqueue(pMsgItem);
    SetEvent(m_hEvent);
}

void CTPMsgQueue::_Output_MD(SMsgItem* pMsgItem)
{
    Output_OnRtnDepthMarketData(pMsgItem);
}

void CTPMsgQueue::_Output_TD(SMsgItem* pMsgItem)
{
...
void CTPMsgQueue::Input_OnConnect(void* pApi, CThostFtdcRspUserLoginField *pRspUserLogin, ConnectionStatus result)
{
...
void CTPMsgQueue::Input_OnDisconnect(void* pApi, CThostFtdcRspInfoField *pRspInfo, ConnectionStatus step)
{
    SMsgItem* pItem = new SMsgItem;
    if (pItem)
    {
...
void CTPMsgQueue::Input_OnRspError(void* pApi, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
    if (NULL == pRspInfo)
        return;
...
void CTPMsgQueue::Input_OnRtnDepthMarketData(void* pMdApi, CThostFtdcDepthMarketDataField *pDepthMarketData)
{
...
void CTPMsgQueue::Input_OnRtnInstrumentStatus(void* pTraderApi, CThostFtdcInstrumentStatusField *pInstrumentStatus)
{
...
void CTPMsgQueue::Input_OnRtnOrder(void* pTraderApi, CThostFtdcOrderField *pOrder)
{
    if (NULL == pOrder)
        return;
...
void CTPMsgQueue::Input_OnRtnTrade(void* pTraderApi, CThostFtdcTradeField *pTrade)
{
    if (NULL == pTrade)
        return;
...
void CTPMsgQueue::Input_OnRspOrderInsert(void* pTraderApi, CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (NULL == pInputOrder
        &&NULL == pRspInfo)
        return;
...
void CTPMsgQueue::Input_OnRspQryInstrument(void* pTraderApi, CThostFtdcInstrumentField *pInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (NULL == pInstrument
        &&NULL == pRspInfo)
        return;
...
void CTPMsgQueue::Input_OnRspQryInstrumentMarginRate(void* pTraderApi, CThostFtdcInstrumentMarginRateField *pInstrumentMarginRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTPMsgQueue::Input_OnRspQryInstrumentCommissionRate(void* pTraderApi, CThostFtdcInstrumentCommissionRateField *pInstrumentCommissionRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTPMsgQueue::Input_OnRspQryInvestorPosition(void* pTraderApi, CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTPMsgQueue::Input_OnRspQryInvestorPositionDetail(void* pTraderApi, CThostFtdcInvestorPositionDetailField *pInvestorPositionDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTPMsgQueue::Input_OnErrRtnOrderInsert(void* pTraderApi, CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo)
{
    if (NULL == pInputOrder
        &&NULL == pRspInfo)
        return;
...
void CTPMsgQueue::Input_OnRspOrderAction(void* pTraderApi, CThostFtdcInputOrderActionField *pInputOrderAction, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTPMsgQueue::Input_OnErrRtnOrderAction(void* pTraderApi, CThostFtdcOrderActionField *pOrderAction, CThostFtdcRspInfoField *pRspInfo)
{
...
void CTPMsgQueue::Input_OnRspQryOrder(void* pTraderApi, CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (NULL == pOrder
        &&NULL == pRspInfo)
        return;
...
void CTPMsgQueue::Input_OnRspQryTrade(void* pTraderApi, CThostFtdcTradeField *pTrade, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (NULL == pTrade
        &&NULL == pRspInfo)
        return;
...
void CTPMsgQueue::Input_OnRspQryTradingAccount(void* pTraderApi, CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void CTPMsgQueue::Input_OnRspQryDepthMarketData(void* pTraderApi, CThostFtdcDepthMarketDataField *pDepthMarketData, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (NULL == pDepthMarketData
        &&NULL == pRspInfo)
        return;
