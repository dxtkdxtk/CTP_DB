...
void TraderApi::RegisterMsgQueue(CTPMsgQueue* pMsgQueue)
{
    m_msgQueue = pMsgQueue;
}

bool TraderApi::IsErrorRspInfo(CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
bool TraderApi::IsErrorRspInfo(CThostFtdcRspInfoField *pRspInfo)
{
    bool bRet = ((pRspInfo) && (pRspInfo->ErrorID != 0));
...
void TraderApi::Connect(const string& szPath,
...
TraderApi::SRequest* TraderApi::MakeRequestBuf(RequestType type)
{
...
void TraderApi::ReleaseRequestListBuf()
{
    CLock cl(&m_csList);
...
void TraderApi::ReleaseRequestMapBuf()
{
    CLock cl(&m_csMap);
...
void TraderApi::ReleaseRequestMapBuf(int nRequestID)
{
    CLock cl(&m_csMap);
...
void TraderApi::AddRequestMapBuf(int nRequestID, SRequest* pRequest)
{
    if (NULL == pRequest)
        return;
...
{
    TraderApi* pTrade = reinterpret_cast<TraderApi *>(lpParam);
    if (pTrade)
        pTrade->RunInThread();
    return 0;
}

void TraderApi::AddToSendQueue(SRequest * pRequest)
{
    if (NULL == pRequest)
        return;
...
void TraderApi::ReqAuthenticate()
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspAuthenticate(CThostFtdcRspAuthenticateField *pRspAuthenticateField, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
...
void TraderApi::ReqSettlementInfoConfirm()
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (!IsErrorRspInfo(pRspInfo)
...
void TraderApi::OnRspOrderInsert(CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
        m_msgQueue->Input_OnRspOrderInsert(this, pInputOrder, pRspInfo, nRequestID, bIsLast);
}

void TraderApi::OnErrRtnOrderInsert(CThostFtdcInputOrderField *pInputOrder, CThostFtdcRspInfoField *pRspInfo)
{
    if (m_msgQueue)
...
void TraderApi::ReqOrderAction(CThostFtdcOrderField *pOrder)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnErrRtnOrderAction(CThostFtdcOrderActionField *pOrderAction, CThostFtdcRspInfoField *pRspInfo)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryTradingAccount()
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryTradingAccount(CThostFtdcTradingAccountField *pTradingAccount, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryInvestorPosition(const string& szInstrumentId)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryInvestorPosition(CThostFtdcInvestorPositionField *pInvestorPosition, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryInvestorPositionDetail(const string& szInstrumentId)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryInvestorPositionDetail(CThostFtdcInvestorPositionDetailField *pInvestorPositionDetail, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryInstrument(const string& szInstrumentId)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryInstrument(CThostFtdcInstrumentField *pInstrument, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryInstrumentCommissionRate(const string& szInstrumentId)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryInstrumentCommissionRate(CThostFtdcInstrumentCommissionRateField *pInstrumentCommissionRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryInstrumentMarginRate(const string& szInstrumentId, TThostFtdcHedgeFlagType HedgeFlag)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryInstrumentMarginRate(CThostFtdcInstrumentMarginRateField *pInstrumentMarginRate, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::ReqQryDepthMarketData(const string& szInstrumentId)
{
    if (NULL == m_pApi)
        return;
...
void TraderApi::OnRspQryDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::OnRspQryOrder(CThostFtdcOrderField *pOrder, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::OnRspQryTrade(CThostFtdcTradeField *pTrade, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast)
{
    if (m_msgQueue)
...
void TraderApi::OnRtnInstrumentStatus(CThostFtdcInstrumentStatusField *pInstrumentStatus)
{
    if (m_msgQueue)
